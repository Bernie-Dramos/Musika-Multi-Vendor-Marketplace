...
export const accommodationServices = [
  {
    ...
    tags: ['Highly Recommended', 'Trusted', 'Room'],
  ...
  },
  {
    ...
    category: 'accommodation',
    tags: ['Cultural Immersion', 'Modern', 'Room'],
  ...
  },
  {
    ...
    category: 'accommodation',
    tags: ['Popular Choice', 'On-Campus', 'Room'],
  ...
  },
  {
    ...
    category: 'accommodation',
    tags: ['Budget-friendly', 'Student House', 'Room'],
...
export const electronicsProducts = [
  {
    ...
    tags: ['Best Seller', 'Student Discount', 'Gadget', 'Electrical Gadgets'],
  ...
  },
  {
    ...
    category: 'electronics',
    tags: ['Affordable', 'Ergonomic', 'Gadget', 'Electrical Gadgets'],
  ...
  },
  {
    ...
    category: 'electronics',
    tags: ['Portable', 'Waterproof', 'Gadget', 'Electrical Gadgets'],
  ...
  },
  {
    ...
    category: 'electronics',
    tags: ['Essential', 'Multi-function', 'Gadget'],
  ...
  },
  {
    ...
    category: 'electronics',
    tags: ['Comfortable', 'Long Battery', 'Gadget'],
...
export const beautyProducts = [
  ...
  },
  {
    ...
    category: 'beauty',
    tags: ['Barbershop', 'Student Special'],
    description: 'Expert haircut, beard trim, and styling by professional barbers. Relaxing environment with complimentary student beverage.',
    features: ['Precision Cut', 'Beard Grooming', 'Style Consultation', 'Complimentary Drink'],
    price: 249,
    priceUnit: 'visit',
    rating: 4.9,
    reviews: 142,
    vendor: 'Campus Cuts Barbershop',
    vendorVerified: true,
...
export const healthcareProducts = [
  {
    ...
    category: 'healthcare',
    tags: ['Essential', 'Fast Reading', 'Health & Wellness'],
  ...
  },
  {
    ...
    category: 'healthcare',
    tags: ['Complete', 'Travel Size', 'Health & Wellness'],
  ...
  },
  {
    ...
    category: 'healthcare',
    tags: ['Exercise', 'Eco-Friendly', 'Health & Wellness'],
...
export const diningProducts = [
  {
    ...
    category: 'dining',
    tags: ['Healthy', 'Affordable', 'Food Delivery'],
  ...
  {
    id: 403,
    title: 'Fresh Home-Style North Indian Thali',
    category: 'dining',
    tags: ['Food Delivery', 'Healthy'],
    description: 'Authentic home-cooked North Indian Thali including 2 Curries, Dal, Rice, 3 Rotis, Salad, and Sweet. Delivered fresh and hot.',
    features: ['Pure Vegetarian', 'Zero Preservatives', 'Eco-Friendly Packing', 'Hot Delivery'],
    price: 189,
    priceUnit: 'order',
    rating: 4.8,
    reviews: 215,
    vendor: "Mom's Kitchen Delivery",
    vendorVerified: true,
...
export const transportationServices = [
  {
    ...
    tags: ['High Recommended', 'Trusted', 'Transportation'],
  ...
  },
  {
    ...
    category: 'transportation',
    tags: ['Student Discount', 'Unlimited', 'Transportation'],
  ...
  },
  {
    ...
    category: 'transportation',
    tags: ['Eco-Friendly', 'Exercise', 'Transportation'],
...
export const legalServices = [
  {
    ...
    category: 'legal',
    tags: ['Professional', 'Experienced', 'Legal'],
