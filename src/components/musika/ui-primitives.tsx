  ...
  return (
    <div className="relative mx-auto w-full max-w-3xl">
      ...
      <input
        ...
        className="h-12 w-full rounded-full border border-[#e5e7eb] bg-white pl-12 pr-28 text-sm text-[#111111] placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[#111111]"
      />
      <div className="absolute right-3 top-1/2 flex -translate-y-1/2 items-center gap-1">
        <button className="rounded-full p-2 text-[#6b7280] transition-all duration-150 hover:bg-[#f3f4f6] hover:text-[#111111]" aria-label="Voice search">
          <Mic className="h-4 w-4" />
        </button>
        <button className="rounded-full p-2 text-[#6b7280] transition-all duration-150 hover:bg-[#f3f4f6] hover:text-[#111111]" aria-label="Image search">
